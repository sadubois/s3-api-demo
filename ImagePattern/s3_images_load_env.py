...
print "# CEPH RADOSGW7S3 CONECCTION DETAILLS"
print "SECRET_KEY='"+secret_key+"'"
print "ACCESS_KEY='"+access_key+"'"
print ""

#access_key = 'F8T4P40OCX8KD96SVDX0'
#secret_key = 'mSTz7NNOpsn27cc03Rfez+FpHdV2lHn4BinLGG3N'
